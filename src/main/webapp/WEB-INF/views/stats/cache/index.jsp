...
<div class="container">
	<div class="panel panel-custom">
		<div class="panel-heading">
			<div class="row">
				<div class="col-md-9">
					<h3 class="panel-title">Cache Info</h3>
				</div>
				...
				<div class="panel panel-custom">
					<div class="row">
						<div class="panel-body">
							...
							<div class="col-md-9">
								${helper:getFormattedDateWithSec(cacheStats.createdAt)}
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 col-md-offset-1">
						<div class="panel panel-custom">
							<div class="panel-heading">
								<h3 class="panel-title">Cleaning Task</h3>
							</div>
							<table class="table table-bordered">
								<tr>
									<th class="align-right">Next cleaning:</th>
									<td>${helper:getFormattedDateWithSec(cacheStats.nextRunTime)}</td>
								</tr>
								<tr>
									<th class="align-right">Purging date:</th>
		...
		<div class="panel-body">
			<div class="container half-width">
				<form method="get" role="form" action="/stats/cache">
					<select name="timeframe" class="form-control input-sm"
